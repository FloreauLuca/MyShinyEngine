...
namespace shiny
{
  void TextureImage::InitTextureImage(VkDevice& device, VkPhysicalDevice& physical_device, VkCommandPool& command_pool, VkQueue& graphics_queue)
  {
    device_ = &device;
    ...
    Buffer::CreateBuffer(device, physical_device, imageSize,
    ...
    TextureImage::CreateImage(device, physical_device, texWidth, texHeight,
  ...
  void TextureImage::CreateImage(VkDevice& device, VkPhysicalDevice& physical_device, uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
    ...
    allocInfo.memoryTypeIndex = Buffer::FindMemoryType(physical_device, memRequirements.memoryTypeBits, properties);
  ...
  void TextureImage::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
    VkCommandBuffer commandBuffer = Buffer::BeginSingleTimeCommands(*device_, *command_pool_);
    ...
    Buffer::EndSingleTimeCommands(*device_, *command_pool_, *graphics_queue_, commandBuffer);
  }
